...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/prayangshu/Desktop/MockDasher/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Users/prayangshu/Desktop/MockDasher/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'two-factor.regenerate-recovery-codes','dashboard','user.tests.start',
'user.writing.show','user.writing.autosave','user.writing.submit','user.speaking.show','user.speaking.submit',
'user.listening.show','user.listening.autosave','user.listening.completeSection','user.listening.submit','user.reading.show',
'user.reading.autosave','user.reading.submit','profile.show','profile.update','profile.destroy',
'user.history.index','user.history.show','admin.collections.index','admin.collections.create','admin.collections.store',
'admin.collections.show','admin.collections.edit','admin.collections.update','admin.collections.destroy','admin.tests.index',
'admin.tests.create','admin.tests.store','admin.tests.show','admin.tests.edit','admin.tests.update',
'admin.tests.destroy','admin.dashboard','admin.writing-tasks.create','admin.writing-tasks.store','admin.writing-tasks.edit',
'admin.writing-tasks.update','admin.writing-tasks.destroy','admin.speaking-questions.create','admin.speaking-questions.store','admin.speaking-questions.edit',
'admin.speaking-questions.update','admin.speaking-questions.destroy','admin.listening-sections.create','admin.listening-sections.store','admin.listening-sections.edit',
'admin.listening-sections.update','admin.listening-sections.destroy','admin.reading-passages.create','admin.reading-passages.store','admin.reading-passages.edit',
'admin.reading-passages.update','admin.reading-passages.destroy','admin.reading-question-groups.create','admin.reading-question-groups.store','admin.reading-question-groups.edit',
'admin.reading-question-groups.update','admin.reading-question-groups.destroy','admin.questions.create','admin.questions.store','admin.questions.edit',
'admin.questions.update','admin.questions.destroy','admin.users.index','admin.users.edit','admin.users.update',
'admin.users.destroy','admin.results.index','admin.results.show','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.collections.create','admin.collections.edit','admin.collections.index','admin.collections.show','admin.dashboard',
'admin.listening-sections.create','admin.listening-sections.edit','admin.questions.create','admin.questions.edit','admin.reading-passages.create',
'admin.reading-passages.edit','admin.reading-question-groups.create','admin.reading-question-groups.edit','admin.results.index','admin.results.show',
'admin.speaking-questions.create','admin.speaking-questions.edit','admin.tests.create','admin.tests.edit','admin.tests.index',
'admin.tests.show','admin.users.edit','admin.users.index','admin.writing-tasks.create','admin.writing-tasks.edit',
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.two-factor-challenge','auth.verify-email','layouts.admin','layouts.app','profile.show',
'user.dashboard','user.history.index','user.history.show','user.listening-test.show','user.reading-test.show',
'user.speaking-test.show','user.tests.placeholder','user.writing-test.show','welcome','laravel-exceptions-renderer::components.badge',
