...
@php
    $base = 'inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-medium perfect-shape btn-active-state transition-ui focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-[var(--color-primary)] disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100 cursor-pointer';
