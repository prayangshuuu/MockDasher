    ...
    <div class="flex h-screen pt-16">
        ...
        <aside class="w-64 bg-white shadow-lg flex-shrink-0 h-full overflow-y-auto border-r border-gray-200">
            <div class="py-6 px-4">
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('admin.collections.index') }}" class="group flex items-center px-3 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('admin.writing-tasks.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-700' }} transition">
                    ...
                    <a href="{{ route('admin.collections.index') }}" class="group flex items-center px-3 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('admin.speaking-questions.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-700' }} transition">
                    ...
                    <a href="{{ route('admin.collections.index') }}" class="group flex items-center px-3 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('admin.listening-sections.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-700' }} transition">
                    ...
                    <a href="{{ route('admin.collections.index') }}" class="group flex items-center px-3 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('admin.reading-passages.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-700' }} transition">
                        <i class="fas fa-book-open w-6 text-center mr-2 {{ request()->routeIs('admin.reading-passages.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"></i>
                        Reading Module
                    </a>
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 pb-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <!-- Alerts -->
                @if(session('success'))
                    <div class="bg-green-50 border-l-4 border-green-400 p-4 mb-6 rounded shadow-sm flex items-center">
                        <i class="fas fa-check-circle text-green-400 text-xl mr-3"></i>
                        <p class="text-green-700 text-sm font-medium">{{ session('success') }}</p>
                    </div>
                @endif
                @if(session('error'))
                    <div class="bg-red-50 border-l-4 border-red-400 p-4 mb-6 rounded shadow-sm flex items-center">
