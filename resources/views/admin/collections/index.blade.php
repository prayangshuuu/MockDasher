                    ...
                    <li class="p-6 hover:bg-gray-50 transition">
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                            ...
                            <div class="flex items-center gap-2 flex-shrink-0">
                                ...
                                <form action="{{ route('admin.collections.destroy', $collection->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this collection and ALL its tests?');">
                                    @csrf
                                    @method('DELETE')
