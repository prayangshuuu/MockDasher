...
@section('title', 'Test Set Details')
@section('header', 'Manage Modules: Test Set ' . $test_set->set_number)
@section('subheader', 'Part of ' . $test_set->test->title)

@section('header_actions')
    <div class="flex space-x-3">
        <a href="{{ route('admin.tests.show', $test_set->test_id) }}" class="text-gray-600 hover:text-gray-900 font-medium transition flex items-center px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden flex flex-col">
            <div class="px-6 py-4 border-b border-gray-200 bg-blue-50 flex justify-between items-center">
                ...
                <a href="{{ route('admin.writing-tasks.create', $test_set->id) }}" class="text-sm font-medium text-blue-700 hover:bg-blue-100 px-3 py-1 rounded transition">Add Task</a>
            </div>
        ...
        <div class="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden flex flex-col">
            <div class="px-6 py-4 border-b border-gray-200 bg-green-50 flex justify-between items-center">
                ...
                <a href="{{ route('admin.speaking-questions.create', $test_set->id) }}" class="text-sm font-medium text-green-700 hover:bg-green-100 px-3 py-1 rounded transition">Add Question</a>
            </div>
            <div class="p-6 flex-1">
        ...
        <div class="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden flex flex-col">
            <div class="px-6 py-4 border-b border-gray-200 bg-purple-50 flex justify-between items-center">
                ...
                <a href="{{ route('admin.listening-sections.create', $test_set->id) }}" class="text-sm font-medium text-purple-700 hover:bg-purple-100 px-3 py-1 rounded transition">Add Section</a>
            </div>
            <div class="p-6 flex-1">
        ...
        <div class="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden flex flex-col">
            <div class="px-6 py-4 border-b border-gray-200 bg-orange-50 flex justify-between items-center">
                ...
                <a href="{{ route('admin.reading-passages.create', $test_set->id) }}" class="text-sm font-medium text-orange-700 hover:bg-orange-100 px-3 py-1 rounded transition">Add Passage</a>
            </div>
            <div class="p-6 flex-1">
